...
namespace SteamBot
{
    ...
    public class AdminUserHandler : UserHandler
    {
        ...
        {
            Bot.SteamFriends.JoinChat(103582791431369904);
        }
        ...
        public override void OnMessage(string message, EChatEntryType type)
        {
            ...
            if (type == EChatEntryType.WasKicked)
            {
                Bot.SteamFriends.JoinChat(103582791431369904);
                Log.Warn("callback called 2");
            }
        }
        ...
        /// <summary>
        /// Called when the bot is sent a message in a chat room
        /// </summary>
